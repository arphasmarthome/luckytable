      ...
      <div style={{ flex: "1 1 auto", display: "flex", flexDirection: "column", gap: "clamp(16px,1.6vw,28px)", padding: "0 clamp(24px,2.6vw,48px) clamp(24px,2.6vw,44px)", minHeight: 0 }}>
          ...
          {captured.map((d) => (
            <div key={d.name} style={{ background: "var(--color-surface)", borderRadius: "var(--radius-lg)", padding: "clamp(14px,1.3vw,22px)", display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
                <div style={{ fontFamily: "var(--font-body)", fontWeight: 700, fontSize: "clamp(18px,1.5vw,26px)", lineHeight: 1.15 }}>{d.label}</div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <span style={{ fontFamily: "var(--font-body)", fontWeight: 700, fontSize: "clamp(22px,1.9vw,32px)", minWidth: "2ch", textAlign: "center" }}>{d.qty}</span>
        ...
        <div className="action-bar" style={{ flex: "0 0 auto", display: "flex", alignItems: "center", gap: "clamp(12px,1.2vw,20px)", background: "var(--color-neutral-100)", borderRadius: "999px", padding: "clamp(12px,1.1vw,18px) clamp(18px,1.6vw,28px)", boxShadow: "var(--shadow-sm)", flexWrap: "wrap" }}>
          ...
          <button
            ...
            style={{ marginLeft: "auto", border: "2px solid var(--color-neutral-400)", background: "transparent", color: "var(--color-text)", borderRadius: "999px", padding: "clamp(12px,1.1vw,18px) clamp(20px,1.8vw,32px)", fontFamily: "var(--font-body)", fontWeight: 700, fontSize: "clamp(16px,1.25vw,22px)", cursor: "pointer" }}
          >
            {str.addToStock}
          </button>
          <button
            ...
            style={{ border: "none", background: "var(--color-accent)", color: "var(--color-accent-100)", borderRadius: "999px", padding: "clamp(12px,1.1vw,18px) clamp(24px,2.2vw,40px)", fontFamily: "var(--font-body)", fontWeight: 700, fontSize: "clamp(16px,1.25vw,22px)", cursor: "pointer" }}
          >
            {str.letsCook}
          </button>
        </div>
