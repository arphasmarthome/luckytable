...
import { Button, EmptyNote, Icon, Page } from "@/components/ui";
...
export default function CartScreen() {
  ...
  const checkout = () => {
    void Linking.openURL(INSTACART_URL).catch(() => toast(t.copyFail));
  };
  ...
  return (
    <Page background={make.background} gap={12}>
      ...
      <View style={{ marginTop: "auto", gap: 8 }}>
        <Button size="lg" variant="primary" accent={make.primary} icon="shopping-cart" disabled={!cart.length} label={t.checkoutInstacart} onPress={checkout} />
