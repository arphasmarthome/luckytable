      ...
      {steps.map((s, i) => {
        ...
        return (
          <Pressable
            ...
            <View style={{ width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center", backgroundColor: s.done ? make.green : current ? make.yellowStrong : make.surface2 }}>
              {s.done ? <Icon name="check" size={22} color="#fff" /> : (
