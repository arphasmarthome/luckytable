...
const en = {
  ...
  hintHome: "Snapshot is used immediately or added to your stock count.", reviewNone: "Nothing captured yet", review: "Review",
  ...
  titles: { capture: "Capture items", review: "What we found", canmake: "What can I make", wantmake: "I want to make", stock: "What's in stock", share: "Share", recipes: "Recipes", cook: "Cooking", cart: "Shopping cart" },
  ...
  play: "Start", pause: "Pause", resume: "Resume", plusMin: "+1 min", reset: "Reset", done: "Done", next: "Next", stepDone: "Done", startAll: "Start all", pauseAll: "Pause all",
...
const zh: MakeStrings = {
  ...
  hintHome: "照片會立即使用，或加入你的庫存。", reviewNone: "尚未拍攝", review: "確認",
  ...
  titles: { capture: "拍攝食材", review: "辨識結果", canmake: "我能做什麼", wantmake: "我想做", stock: "庫存清單", share: "分享", recipes: "食譜", cook: "料理中", cart: "購物車" },
